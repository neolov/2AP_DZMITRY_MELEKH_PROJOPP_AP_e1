const products = [
    {
        ...
        price: "900$",
        images: ["../img/gen of vinity/t-shirt.jpg", "../img/gen of vinity/photo1.jpg", "../img/gen of vinity/photo 2.jpg"],
    ...
    },
    {
        ...
        price: "$350.00",
        images: ["../img/koe no katachi/T-shirt koe no katachi.jpg", "../img/koe no katachi/T-shirt koe no katachi back.png", "../img/koe no katachi/T-shirt koe na katachi first.jpg", "../img/koe no katachi//T-shirt koe no katachi second.jpg"],
    ...
    },
    {
        ...
        price: "$550.00",
        images: ["../img/koe no katachi/koe no katachi long.png", "../img/koe no katachi/koe no katachi long back.png", "../img/koe no katachi/koe no katachi long photo.jpg", "../img/koe no katachi/koe no katachi long photo 2.jpg"],
    ...
    },
    {
        ...
        price: "$1101.01",
        images: ["../img/koe no katachi/koe no katachi zip.png", "../img/koe no katachi/koe no katachi zip back.png", "../img/koe no katachi/koe no katachi zip photo.jpg", "../img/koe no katachi/koe no katachi zip photo 2.jpg"],
...
},
{
        ...
        price: "$666.00",
        images: ["../img/i remember/long face.jpg", "../img/i remember/long back.jpg", "../img/i remember/long photo.jpg"],
